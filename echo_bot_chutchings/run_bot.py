...
name = input(name_ask()).strip().lower().title()

#Introduces a basic boolean variable to determine whether my loop should continue

shutdown = True

while shutdown: #Remember: shutdown is a boolean already, so I do not need to make a logical statement here
    ...
    #If the shutdown command is given, the shutdown variable becomes False so the loop is broken
